...
face_classifier = cv2.CascadeClassifier(r'D:\projects\AI Powered Classroom\Emotion recognition\haarcascade_frontalface_default.xml')
classifier = load_model(r'D:\projects\AI Powered Classroom\Emotion recognition\model.h5')
